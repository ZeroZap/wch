...
/******************************************************************************/
/* BulkOnly Mass Storage device specific requests */
...
/******************************************************************************/
/* specify the current small capacity usb flash drive size to 32K */
...
/******************************************************************************/
/* macro definition of the current udsik(it can be modified as needed) */
...
#define DEF_UDISK_SECTOR_SIZE      DEF_CFG_DISK_SEC_SIZE                               /* define the sector size of the udsik */
...
/******************************************************************************/
/* macro definition related to the current udisk status */
#define DEF_UDISK_EN_FLAG              0x01

/******************************************************************************/
/* macro definition of the current usb flash drive transfer status */
