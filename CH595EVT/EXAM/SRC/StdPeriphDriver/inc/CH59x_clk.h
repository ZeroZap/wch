...
typedef enum
{
    ...
    CLK_SOURCE_HSE_32MHz = (0x200 | 0x80),
    ...
    CLK_SOURCE_HSI_PLL_80MHz = (0x40 | 6),
    CLK_SOURCE_HSI_PLL_60MHz = (0x40 | 8),
    CLK_SOURCE_HSI_PLL_48MHz = (0x40 | 10),
    CLK_SOURCE_HSI_PLL_32MHz = (0x40 | 15),
    CLK_SOURCE_HSI_PLL_24MHz = (0x40 | 20),

    CLK_SOURCE_HSE_PLL_80MHz = (0x200 | 0x40 | 6),
    CLK_SOURCE_HSE_PLL_60MHz = (0x200 | 0x40 | 8),
    CLK_SOURCE_HSE_PLL_48MHz = (0x200 | 0x40 | 10),
    CLK_SOURCE_HSE_PLL_32MHz = (0x200 | 0x40 | 15),
    CLK_SOURCE_HSE_PLL_24MHz = (0x200 | 0x40 | 20),
