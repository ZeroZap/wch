...
// multi-blocks: __BASE_TYPE__, __CH595SFR_H__, __CH595USBSFR_H__, __USB_TYPE__...
...
#ifndef __CH595SFR_H__
#define __CH595SFR_H__
...
#define  RB_MANU_BOOT_FLAG  0x10                      // RO, program selection after external manual reset: 0=user program, 1=bootloader
...
#define  RB_BOOT_LOADER_MAN 0x01                      // RO, program state after software reset: 0=user program, 1=bootloader
...
#define  RB_CLK_SYS_MOD     0xC0                      // RWA, system clock source mode: 00=divided from 32MHz/16MHz, 01=divided from PLL-480MHz, 10=directly from 32MHz/16MHz, 11=directly from 32KHz
#define  RB_OSC32M_SEL      0x200                     // RWA, PLL clock source selection: 0=HSI, 1=HSE
#define  RB_PLL_GATE_STATUS 0x800                     // RO, PLL clock activation flag
#define  RB_PLL_GATE_DISS   0x1000                    // RWA, turn off PLL clock when switching PLL clock source
#define  RB_PLL_GATE_TIME   0x2000                    // RWA, time selection to turn off PLL clock when switching PLL clock source: 0=30us, 1=40us
...
// ( ( RB_CLK_SYS_MOD [0] ? Fpll / RB_CLK_PLL_DIV : ( RB_OSC32M_SEL ? Fck32m : Fck16m ) ) / RB_CLK_PLL_DIV )
// default: Fsys = Fck16m / RB_CLK_PLL_DIV = 16MHz / 3 = 5.33MHz
//   range: 32KHz, 1MHz~32MHz, 15MHz~80MHz
...
#define  RB_SLP_CLK_LED     0x02                      // RWA, close LED clock
...
#define  RB_SLP_CLK_ADC     0x20                      // RWA, close ADC clock
...
#define  RB_SLP_UART_WAKE   0x02                      // RWA, enable UART waking
#define  RB_SLP_GPIO_EDGE_MODE 0x04                   // RWA, when RB_GPIO_WAKE_MODE=1,GPIO waking edge select:1=all edge,0=pos edge
...
#define  RB_SLP_CLK_RAM8K   0x20                      // RWA, close retention 8KB SRAM clock
#define  RB_RAM_RET_LV      0xC0                      // RWA, SRAM retention voltage selection: 0=normal, 1/2/3=low power mode1/2/3

#define R8_LONG_RST_CFG     (*((PUINT8V)0x40001014))  // RWA, long reset configuration
#define  RB_LONG_RST_EN     0x01                      // RWA, enable long reset 
#define  RB_LONG_TIM_SEL    0x06                      // RWA, long reset time selection: 00=15ms(HSE)/30ms(HSI), 01=20ms(HSE)/40ms(HSI), 10=25ms(HSE)/50ms(HSI), 11=32.768ms(HSE)/65.536ms(HSI)
#define R8_SLP_CLK_OFF2     (*((PUINT8V)0x40001015))  // RWA, sleep clock off control byte 2, SAM
#define  RB_CLK_OFF_DEBUG   0x02                      // RWA, close debug clock
#define  RB_CLK_OFF_ENC     0x10                      // RWA, close ENC clock
#define  RB_CLK_OFF_KEYSCAN 0x20                      // RWA, close KEYSCAN clock
#define  RB_SLP_ENC_WAKE    0x40                      // RWA, enable ENC waking
#define  RB_SLP_KEYSCAN_WAKE 0x80                     // RWA, enable KEYSCAN waking
#define R16_SLP_WAKE_CFG    (*((PUINT16V)0x40001016)) // RWA, sleep configuration
#define  RB_PRECLK_CNT_EN   0x10                      // RWA, time to release FCLK after waking up: 0=immediately, 1=wait for a certain time
#define  RB_PRECLK_CNT_SEL  0x60                      // RWA, cycle of sleep time: 0=2048, 1=1024, 2=512, 3=256
#define  RB_ACAUTO_ENABLE   0x100                     // RW, secure register channel automatically close
#define  RB_UART_DLY_EN     0x200                     // RWA, enable uart receive delay
#define  RB_UART_WAKE_INT   0x400                     // RWA, interrupt flag for uart wake up
#define  RB_UART_DLY_IDLE   0x800                     // RO, when enable RB_UART_DLY_EN, UART receive status:0=no data, 1=received data
#define  RB_DEBUG_EN        0x1000                    // RWA, enable debug
#define  RB_MANURST_SEL     0x8000                    // RWA, program selection after external manual reset: 0=user program, 1=bootloader
...
#define  RB_PIN_ENC         0x10                      // RW, ENC alternate pin enable: 0=CAP_IN1/CAP_IN2 on PB[10]/PB[11], 1=CAP_IN1/CAP_IN2 on PA[10]/PA[11]
#define  RB_PIN_LED         0x20                      // RW, LED alternate pin enable: 0=LED[3]/LED[2]/LED[1]/LED[0]/LED_CLK on PA[11]/PA[12]/PA[13]/PA[14]/PA[15], 1=LED[3]/LED[2]/LED[1]/LED[0]/LED_CLK on PB[11]/PB[12]/PB[13]/PB[14]/PB[15]
#define  RB_UDP_PU_EN   	0x40                      // RW, USB UDP internal pullup resistance enable: 0=enable/disable by RB_UC_DEV_PU_EN, 1=enable pullup, replace RB_UC_DEV_PU_EN under sleep mode
...
#define  RB_PWR_RAM24K      0x02                      // RWA, power for main SRAM
...
#define  RB_PWR_RAM8K       0x10                      // RWA, power for retention 8KB SRAM
...
#define  RB_CFG_IVREF       0xF00                     // RWA, must keep unchanged
...
#define  RB_BAT_LOW_NMI     0x04                      // RWA, interrupt type for battery lower voltage: 0=peripheral interrupt, 1=NMI interrupt
...
#define  RB_BAT_LOW_VTH     0x07                      // RWA, select detector/monitor threshold voltage of battery voltage low
...
#define  RB_RC32K_I_TUNE    0x0C                      // RWA, internal 32KHz oscillator current tune: 00=70% current, 01=standard current, 10=140% current, 11=60% current
...
#define  RB_ADC_CLK_DIV     0x40                      // RW, select ADC clock frequency: 0=16MHz, 1=32MHz
...
#define  RB_ADC_CHAN_EN     0x08                      // RW, enable ADC channel
#define  RB_ADC_SAMPLE_TIME 0x30                      // RW, ADC sampling cycle: 00=4, 01=6, 10=8, 11=10
...
#define  RB_ADC_IF_EOC      0x80                      // RO, ADC conversion interrupt flag: 0=free or converting, 1=end of conversion, interrupt action, auto ADC or write R8_ADC_CONVERT or write RB_TKEY_CTRANS_ACT to clear flag


#define R8_TKEY_CFG        (*((PUINT8V)0x40001057))   // RW, Touchkey configure
#define  RB_TKEY_DRV_EN     0x04                      // RW, Touchkey drive shield enable
#define  RB_ADC_PGA_CFG    	0x08                      // RW, ADC input PGA speed selection: 0=normal, 1=fast
#define  RB_TKEY_DMA_EN     0x40                      // RW, Touchkey DMA enable
#define R32_TKEY_CFG2      (*((PUINT32V)0x40001078))  // RW, Touchkey control2
#define  RB_TKEY_TRANS      0x07                      // RW, Touchkey charge transfer time(Tsys): 000=1, 001=4, 010=8, 011=12, 100=16, 101=24, 110=32, 111=48
#define  RB_TKEY_CC         0x18                      // RW, Touchkey capacitor charging time(Tsys): 00=1, 01=2, 10=3, 11=4 
#define  RB_TKADC_START_SEL 0x60                      // RW, number of transfer cycle to start ADC in advance: 00=2, 01=4, 10=8, 11=16
#define  RB_TKEY_EN         0x80                      // RW, enable Touchkey
#define  RB_TKEY_CTRANS_ACT 0x100                     // RW, Touchkey start signal and status, auto clear
#define  RB_TRANSFER_N      0x3FF0000                 // RW, number of transfer cycle
#define R32_TKEY_SEL        (*((PUINT32V)0x4000107C)) // RW, Touchkey select
#define  RB_SEL_S           0x3FFF                    // RW, selection of charge transfer channels
#define  RB_DRIVEROUT_EN    0x3FFF0000                // RW, Touchkey drive shielding channel selection switch
...
#define  RB_ADC_SCAN_CH12   0x0000F000                // RW, ADC Channel 12 analog input channel selection bit
#define  RB_ADC_SCAN_CH13   0x000F0000                // RW, ADC Channel 13 analog input channel selection bit
#define  RB_EHCH_TIM        0x00300000                // RW, times of ADC scanning channels
#define  RB_ADC_SCAN_EN     0x00800000                // RW, enable channel scan mode
#define  RB_ADC_SCAN_NUM    0x0F000000                // RW, Number of ADC scanning channels
#define  RB_ADC_SCAN_SEL    0x10000000                // RW, ADC scan function selection: 0=TKEY, 1=ADC
#define  RB_ADC_IE_SCAN_END 0x20000000                // RW, ADC scan end interrupt enable: 0=disable, 1=enable
#define  RB_ADC_SCAN_MASKDIS 0x40000000               // RW, enable to close channel after sampling:0=enable to close, 1=disable to close
#define  RB_ADC_IF_SCAN_END 0x80000000                // RW, ADC scan end flag, write 1 to clear

/* System: Flash ROM control register */
#define R32_FLASH_CTRL      (*((PUINT32V)0x40001800)) // RWA, flash ROM control
#define R8_PREPG_CTRL      	(*((PUINT8V)0x40001800))  // RWA, flash ROM preprogram control
#define  RB_PREG_AUTO_EN  	0x01				      // RWA, flash ROM preprogram automode enable
#define  RB_PREG_MODE  		0x06				      // RWA, flash ROM preprogram mode
#define  RB_PREG_START  	0x10				      // RWA, flash ROM preprogram start
#define R8_BUF_CTRL      	(*((PUINT8V)0x40001801))  // RWA, flash ROM buf control
#define  RB_BUF_CLR_START  	0x01				      // RWA, flash ROM buf clear
#define  RB_BUF_LOAD_START 	0x10				      // RWA, flash ROM buf load
#define  RB_BUF_LOAD_AUTO 	0x20				      // RWA, flash ROM buf load automode
#define R8_ERASE_CTRL      	(*((PUINT8V)0x40001802))  // RWA, flash ROM erase control
#define  RB_ERASE_MODE  	0x03				      // RWA, flash ROM erase mode
#define  RB_ERASE_START  	0x10				      // RWA, flash ROM erase start
#define R8_PROGRAM_CTRL    	(*((PUINT8V)0x40001803))  // RWA, flash ROM program control
#define  RB_PROGRAM_START  	0x01				      // RWA, flash ROM program start
#define R32_FLASH_CTRL2     (*((PUINT32V)0x40001804)) // RWA, flash ROM control2
#define R8_READ_CTRL     	(*((PUINT8V)0x40001807))  // RWA, flash ROM read control
#define  RB_CFG_RD_EN  		0x01				      // RWA, flash ROM read enable
#define  RB_RD_START  		0x02				      // RWA, flash ROM read start
#define  RB_WRRD_ADDR_INC 	0x04				      // RWA, flash ROM address increase after read
#define  RB_FLASH_CLK 		0x30				      // RWA, flash ROM clock setting
#define R32_FLASH_CTRL3     (*((PUINT32V)0x40001808)) // RWA, flash ROM control3
#define R8_RDPRCTDIS_CTRL 	(*((PUINT8V)0x40001808))  // RWA, flash ROM rdprotect control
#define  RB_RD_PROTECTDIS_FLAG 0x01				      // RO, flash ROM rdprotect disable flag
#define  RB_RDPROTECT_DISSTATE 0x0e				      // RO, flash ROM rdprotect disable state
#define  RB_RD_PROTECTDIS_START 0xc0				  // RO, flash ROM rdprotect disable start flag
#define R8_CHIP_STATUS 		(*((PUINT8V)0x40001809))  // RO, flash ROM status
#define  RB_RD_PROTECT 		0x01				      // RO, flash ROM rdprotect
#define  RB_DBG_MODE 		0x02				      // RO, flash ROM debug mode
#define  RB_FLASH_HALTED 	0x08				      // RO, flash ROM halted 
#define R32_FLASH_ADDR      (*((PUINT32V)0x4000180C)) // RWA, flash ROM addr
#define R32_FLASH_DATA      (*((PUINT32V)0x40001810)) // RWA, flash ROM data
#define R8_FLASH_DATA       (*((PUINT8V)0x40001810))  // RWA, flash ROM data
#define R32_FLASH_DATA1     (*((PUINT32V)0x40001814)) // RO, flash ROM data1
#define R8_FLASH_DATA1      (*((PUINT8V)0x40001814))  // RO, flash ROM data1
#define R32_FLASH_DATA2     (*((PUINT32V)0x40001818)) // RO, flash ROM data2
#define R8_FLASH_DATA2      (*((PUINT8V)0x40001818))  // RO, flash ROM data2
#define R32_FLASH_DATA3     (*((PUINT32V)0x4000181C)) // RO, flash ROM data4
#define R8_FLASH_DATA3      (*((PUINT8V)0x4000181C))  // RO, flash ROM data4
#define R32_FLASH_STATUS    (*((PUINT32V)0x40001820)) // RO, flash ROM status
...
#define R32_PA_SET          (*((PUINT32V)0x400010B8)) // WZ, PA output setting, 0=keep output, 1=output high level
#define R8_PA_SET_0         (*((PUINT8V)0x400010B8))  // WZ, PA output setting byte 0
#define R8_PA_SET_1         (*((PUINT8V)0x400010B9))  // WZ, PA output setting byte 1
...
#define R32_PB_SET          (*((PUINT32V)0x400010D8)) // WZ, PB output setting, 0=keep output, 1=output high level
#define R8_PB_SET_0         (*((PUINT8V)0x400010D8))  // WZ, PB output setting byte 0
#define R8_PB_SET_1         (*((PUINT8V)0x400010D9))  // WZ, PB output setting byte 1
#define R8_PB_SET_2         (*((PUINT8V)0x400010DA))  // WZ, PB output setting byte 2
...
#define  RB_TMR_PWM_REPEAT_EN 0x20                    // RW, in PWM repeat mode, if FIFO is empty and new data is written, the time to switch to new data is: 0=immediately, 1=after sending the current data
...
#define  RB_HI_PWM_EN       0x10                      // RW, enable 160M high frequency PWM mode
...
#define R8_UART0_TXE        (*((PUINT8V)0x40003007))  // RW, UART0 transmit data end
...
#define R8_UART1_TXE        (*((PUINT8V)0x40003407))  // RW, UART1 transmit data end
...
#define R8_UART2_TXE        (*((PUINT8V)0x40003807))  // RW, UART2 transmit data end
...
#define R8_UART3_TXE        (*((PUINT8V)0x40003C07))  // RW, UART3 transmit data end
...
#define UART_TXE            7
#define  RB_UART_TRAN_IE    0x01                      // RW, enable interrupt for UART FIFO data transfer completed
#define  RB_UART_TRAN_IF    0x80                      // RW, interrupt flag for UART FIFO data transfer completed
#define UART_RBR            8
#define UART_THR            8
...
#define R32_SPI0_STATUS1    (*((PUINT32V)0x40004008)) // RW, SPI0 status1
#define R8_SPI0_INT_TYPE    (*((PUINT8V)0x40004008))  // RW, SPI0 interrupt trigger mode selection
#define R8_SPI0_INTER1_EN   (*((PUINT8V)0x40004009))  // RW, SPI0 interrupt1 enable
#define R8_SPI0_INT1_FLAG   (*((PUINT8V)0x4000400A))  // RW1, SPI0 interrupt1 flag
...
#define  RB_MST_CLK_SEL     0x02                      // RW, if master/host, clock polarity selection:0=default , 1=reverse; if slave/device, 2 wire mode in/out directions selection: 0=slave output, 1=slave input 
...
#define SPI_INT_TYPE        8
#define  RB_SPI_INT_TYPE    0x1F                      // RW, interrupt trigger mode selection:0=rising edge trigger, 1= level trigger 
//bit4: RB_SPI_IF_FIFO_FULL, bit3: RB_SPI_IF_FIFO_EMPTY, bit2: RB_SPI_IF_DMA_END, bit1: RB_SPI_IF_FIFO_HF, bit0: RB_SPI_IF_CNT_END
#define SPI_INTER1_EN       9
#define  RB_SPI_IE_FIFO_EMPTY 0x01                    // RW, enable interrupt for SPI0 FIFO empty
#define  RB_SPI_IE_FIFO_FULL 0x02                     // RW, enable interrupt for SPI0 FIFO full
#define SPI_INT1_FLAG       0x0A
#define  RB_SPI_IF_FIFO_EMPTY 0x01                    // RW1, interrupt flag for SPI0 FIFO empty
#define  RB_SPI_IF_FIFO_FULL 0x02                     // RW1, interrupt flag for SPI0 FIFO full
...
#define R32_PWM_INT_CTRL     (*((PUINT32V)0x4000500C)) // RW, PWM interrupt control
...
/* KEYSCAN register */
#define R16_KEY_SCAN_CTRL   (*((PUINT16V)0x40006040))// KEY SCAN control register
...
#define R8_KEY_SCAN_INT_EN  (*((PUINT8V)0x40006042)) // KEY SCAN interupt enable register
...
#define  RB_KEY_RELEASED_IE 0x04                     // RW, detect key released interupt enable 
#define R8_KEY_SCAN_INT_FLAG (*((PUINT8V)0x40006043))// KEY SCAN interupt flag register 
...
#define  RB_KEY_RELEASED_IF 0x04                     // RW1, detect key released flag enable            
#define R32_KEY_SCAN_NUMB   (*((PUINT32V)0x40006044))// SCAN_KEY number address now register
#define  RB_KEY_SCAN_NUMB   0x0FFFFF                 // SCAN_KEY number address now 
#define  RB_KEY_SCAN_CNT    0x700000                 // current SCAN_KEY times

/* ENCODER register */
#define R32_ENC_REG_CTRL    (*((PUINT32V)0x40006080))
#define R8_ENC_REG_CTRL     (*((PUINT8V)0x40006080))  // RW, ENCODER control register
...
#define  RB_ENC_IN_CH1      0x40                      // RO, encoder capture channel 1 value
#define  RB_ENC_IN_CH2      0x80                      // RO, encoder capture channel 2 value
#define R8_ENC_INTER_EN     (*((PUINT8V)0x40006081))  // RW, ENCODER interupt enable register
#define  RB_IE_DIR_INC      0x01                      // RW, encode increase interupt enable 
#define  RB_IE_DIR_DEC      0x02                      // RW, encode decrease interupt enable
#define R8_ENC_INT_FLAG     (*((PUINT8V)0x40006082))  // RW, ENCODER interupt flag register
#define  RB_IF_DIR_INC      0x01                      // RWA, encode increase interupt flag 
#define  RB_IF_DIR_DEC      0x02                      // RWA, encode decrease interupt flag
#define R32_ENC_REG_CEND    (*((PUINT32V)0x40006084))
#define R32_ENC_REG_CCNT    (*((PUINT32V)0x40006088))

/* LED register */
#define R32_LED_CONTROL     (*((PUINT32V)0x4000E000)) // RW, LED control
#define R8_LED_CTRL_MOD     (*((PUINT8V)0x4000E000))  // RW, LED mode control
#define R8_LED_CLOCK_DIV    (*((PUINT8V)0x4000E001))  // RW, LED serial clock divisor
#define R8_LED_STATUS       (*((PUINT8V)0x4000E004))  // RO, LED status
#define R32_LED_FIFO        (*((PUINT32V)0x4000E008)) // WO, LED FIFO register, width is half-word, only low 16 bit
#define R16_LED_FIFO        (*((PUINT16V)0x4000E008)) // WO, LED FIFO register, width is half-word
#define R32_LED_DMA_CNT     (*((PUINT32V)0x4000E010)) // RW, LED DMA main buffer remainder half-word count, exclude auxiliary buffer, automatic decreasing after DMA, only low 12 bit
#define R16_LED_DMA_CNT     (*((PUINT16V)0x4000E010)) // RW, LED DMA main buffer remainder half-word count, exclude auxiliary buffer, automatic decreasing after DMA, only low 12 bit
#define R32_LED_DMA_MAIN    (*((PUINT32V)0x4000E014)) // RW, LED main buffer DMA begin & current address, automatic increasing after DMA
#define R16_LED_DMA_MAIN    (*((PUINT16V)0x4000E014)) // RW, LED main buffer DMA begin & current address, automatic increasing after DMA
#define R32_LED_DMA_AUX     (*((PUINT32V)0x4000E018)) // RW, LED auxiliary buffer DMA begin & current address, automatic increasing after DMA
#define R16_LED_DMA_AUX     (*((PUINT16V)0x4000E018)) // RW, LED auxiliary buffer DMA begin & current address, automatic increasing after DMA

/* LED register address offset and bit define */
#define LED_FIFO_SIZE       2                         // LED FIFO size (depth), width is half-word
#define BA_LED              ((PUINT8V)0x4000E000)     // point LED base address
...
#define BOOT_LOAD_SIZE      0x4000                    // size of boot loader program
#define BOOT_LOAD_CFG       0x40100                   // start address of configuration information for boot loader program
#define ROM_CFG_ADDR        0x40200                   // chip configuration information address

/*----- Reference Information --------------------------------------------*/
#define ID_CH595            0x97                      // chip ID
#define ID_CH596            0x96                      // chip ID
...
#define INT_ID_ENCODER      36                        // interrupt number for ENCODER
#define INT_ID_KEYSCAN      37                        // interrupt number for KEYSCAN
#define INT_ID_LED          38                        // interrupt number for LED
...
#define INT_ADDR_ENCODER    (INT_ID_ENCODER*INT_VEC_ENTRY_SZ) // interrupt vector address for ENCODER
#define INT_ADDR_KEYSCAN    (INT_ID_KEYSCAN*INT_VEC_ENTRY_SZ) // interrupt vector address for KEYSCAN
#define INT_ADDR_LED        (INT_ID_LED*INT_VEC_ENTRY_SZ)     // interrupt vector address for LED
...
#endif  // __CH595SFR_H__


#ifndef __CH595USBSFR_H__
#define __CH595USBSFR_H__
