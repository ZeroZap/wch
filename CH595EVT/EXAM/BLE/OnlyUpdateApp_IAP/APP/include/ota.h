...
/* 整个用户code区分成四块，依次为4K，84K，16K，136K 后三块分别叫做imageA（APP），imageB（IAP），LIB */

/* FLASH定义 */

#define FLASH_BLOCK_SIZE     2 * FLASH_SECTOR_SIZE

/* imageA定义 */
#define IMAGE_A_FLAG         0x01
#define IMAGE_A_START_ADD    0x1000
#define IMAGE_A_SIZE         84 * 1024
...
/* 存放地址不能占用蓝牙的位置 */
#define OTA_DATAFLASH_ADD    IMAGE_A_START_ADD + IMAGE_A_SIZE - 0x100
