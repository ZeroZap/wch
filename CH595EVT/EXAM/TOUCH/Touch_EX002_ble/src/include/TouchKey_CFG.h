...
#define GEN_TKY_CH_INIT(qNum,chNum,hyswin,chBaseline,maxvar,level) \
 ...
 #define TKY_CHS_INIT                                           \
     GEN_TKY_CH_INIT( TKY_QUEUE_0,  0     , 10, 2054, 157, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_1,  5     , 10, 2049, 118, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_2,  3     , 10, 2074, 90 , 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_3,  7     , 10, 2065, 100, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_4,  1     , 10, 2059, 154, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_5,  4     , 10, 2065, 122, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_6,  2     , 10, 2070, 102, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_7,  6     , 10, 2060, 108, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_8,  (1<<0), 10, 2054, 157, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_9,  (1<<5), 10, 2049, 118, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_10, (1<<3), 10, 2074, 90 , 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_11, (1<<7), 10, 2065, 100, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_12, (1<<1), 10, 2059, 154, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_13, (1<<4), 10, 2065, 122, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_14, (1<<2), 10, 2070, 102, 5),\
     GEN_TKY_CH_INIT( TKY_QUEUE_15, (1<<6), 10, 2060, 108, 5)
