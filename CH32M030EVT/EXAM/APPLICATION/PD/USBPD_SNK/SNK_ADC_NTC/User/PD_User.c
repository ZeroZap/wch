...
void PD_User_Timer (void)
{
    ...
    /* Sample the voltage of the NTC resistor once every 1000ms */
    tGetNTDADC--;
    if (!tGetNTDADC) {

        /* NTC 20℃ about 100K, 80℃ about 10K */
        /*32uA 20℃ about 2.6-3.3V, 80℃ about 0.26V-0.3V */
        printf (">NTC Volt=%d,\n", Get_ISRC1_NTC_ADC);
        tGetNTDADC = 1000;
        /*NTC resistor user comparison processing */
    }
