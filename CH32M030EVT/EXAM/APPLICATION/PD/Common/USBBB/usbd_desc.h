...
#define DEF_USBD_QUALFY_DESC_LEN      ( (uint16_t)MyQuaDescr[ 0 ])
...
#define DEF_USBD_ALT_DESC_LEN         ( (uint16_t)iAlternateDescr[ 0 ])
...
extern const uint8_t iAlternateDescr[ ];
