...
#define SPEED_REGULATOR_KI_M      _IQ(0.001)                        // Speed regulator integral coefficient(actual value)
...
#define SPEED_REGULATOR_ULIM_M    _IQ(0.85)                         // Speed regulator upper limit (unit-A per)
