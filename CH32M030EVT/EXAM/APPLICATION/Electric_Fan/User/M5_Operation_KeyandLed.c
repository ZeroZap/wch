...
void KeyandLED_IOInit(void)
{
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_AFIO|RCC_PB2Periph_GPIOA|RCC_PB2Periph_GPIOB|RCC_PB1Periph_PWR, ENABLE);
    ...
    EXTEN->EXTEN_CTLR0&=~(1<<17);
    EXTEN->EXTEN_CTLR0|=(1<<17);

    USBPD1->PORT_CC1&=~CC_PD;
    USBPD1->PORT_CC1&=~CC_PU_80;
